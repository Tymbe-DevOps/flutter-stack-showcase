...
/// Shows overlay to scanner rounded rectangle
class QrScannerOverlayShape extends ShapeBorder {
  const QrScannerOverlayShape({
    this.borderColor = Colors.white,
    this.overlayColor = AppColors.scannerOverlayColor,
  ...
  void paint(Canvas canvas, Rect rect, {TextDirection? textDirection}) {
    ...
    final borderLength =
        this.borderLength > this.cutOutSize / 2 + borderWidth * 2
            ? borderWidthSize / 2
            : this.borderLength;
    final cutOutSize =
        this.cutOutSize < width ? this.cutOutSize : width - borderOffset;
